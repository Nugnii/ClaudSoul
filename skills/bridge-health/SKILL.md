---
name: bridge-health
description: "Мониторинг 16 мостов (15 межслойных + 1 внутрислойный): статус, метрики активности, здоровье связей между когнитивными слоями."
description_en: "Monitors all 16 bridges (15 inter-layer plus one within-layer): status, activity metrics, health of links between cognitive layers."
user-invocable: true
...
Мониторинг здоровья 16 мостов: 15 межслойных между L2-L7 плюс внутрислойный L2↔L2 (cross-contour). Без мониторинга мосты существуют в документации, но неизвестно, работают ли они в реальности.
