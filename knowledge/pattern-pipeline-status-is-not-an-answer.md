...
provenance_log:
  ...
  - date: 2026-08-26
    kind: reinforced
    reason: "12 скриптов ablation и протокол 1.3 при нуле прогонов — статус конвейера был выдан за состояние замера; правило сработало ровно по назначению"
  - date: 2026-08-31
    kind: reinforced
    reason: "находки measurement-due развёрнуты до содержимого каждого замера и починок, а не отчёта «9 прогнано»"
    session: ""
---
