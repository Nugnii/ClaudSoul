...
# en: PreToolUse guard: prevents writing internally-marked content to externally-shared paths.
#
...
#
# Регистрация (install.sh): блок PreToolUse с matcher Bash|Edit|Write|MultiEdit, общий с
# knowledge-activator; тело действует только на Edit | Write (file content available in
# tool_input), на Bash и MultiEdit выходит молча.
...
if [ "$TOOL_NAME" = "Edit" ]; then
    ...
    # Группа PreToolUse в install.sh зовёт страж и на MultiEdit; без этой ветки его правки уходили без сверки.
