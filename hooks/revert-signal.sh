...
HOTFIX_EXCLUDE_RE="${HOTFIX_EXCLUDE_RE:-(dep-index\.tsv|measurements\.tsv|doc-claims\.tsv|CHANGELOG|CHANGELOG-archive|SESSION|BACKLOG|BACKLOG-archive|README|README\.ru)\.?[a-z]*$}"
