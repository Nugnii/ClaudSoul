...
- ☐ **D57** фикстура
BL
    HOME="$tmpd" CLAUDSOUL_BACKLOG="$tmpd/backlog-fixture.md" bash "$COLLECTOR" >/dev/null 2>&1
...
HOME="$_TMPC" CLAUDSOUL_BACKLOG="$_TMPC/backlog-fixture.md" bash "$COLLECTOR" >/dev/null 2>&1
...
HOME="$_TMPD" bash "$COLLECTOR" >/dev/null 2>&1
