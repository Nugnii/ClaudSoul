#!/usr/bin/env bash
# response-tracker.sh — PostToolUse: пишет РЕАКЦИЮ агента после того, как система его о чём-то предупредила.
# en: PostToolUse: records the agent's REACTION after the system warned it about something.
#
