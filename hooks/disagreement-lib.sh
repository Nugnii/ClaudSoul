...
# почему `contradicted_count` равен нулю во всех 265 знаниях базы:
#
...
# и закрыть её документированной процедурой физически не может. На живых данных это
# видно точно: из 5 записей закрыта одна — та, что закрылась через 10 минут внутри
# своей же сессии. Остальные четыре висят с 25, 26 и 27 июля.
#
...
# базы contradicted_count равен нулю во всех 265 знаниях.
#
