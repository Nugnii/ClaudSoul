...
| 🔁 Признак повторяется | five-whys-gate (PreToolUse) | Цепочка «почему» до корня ПРЕЖДЕ правки; симптом чинится где заметили, причина — где возникла |
...
Признак повторился — спускайся цепочкой «почему» до корня, а не перечисляй версии вширь. «2-3 версии причины» выше отвечают на вопрос «какие бывают причины», цепочка — на вопрос «откуда взялась эта». Ширина закрывает ощущение глубины, и разбор считается сделанным на первом же объяснении.
