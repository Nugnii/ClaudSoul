...
└── hooks/tests/           # 277 файлов тестов хуков + 24 mcp (см. секцию 5)
```
...
> Состояние на **v1.31.3** (2026-08-31). Это документ состояния: «как есть сейчас». Что менялось и когда — `CHANGELOG.md`;
...
| Тесты | 277 файлов тестов хуков + 24 mcp (121 mcp-тест); зелёные на macOS и в чистом контейнере Linux; drift-check по 7 парам |
