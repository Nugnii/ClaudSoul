...
# Результат: строка статуса показывает нынешнюю фазу ablation, а не выдуманную
# Проверка результата: bash scripts/statusline-claudsoul.sh печатает фазу, совпадающую с phase.sh status
#
#
