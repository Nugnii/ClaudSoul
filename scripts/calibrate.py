#!/usr/bin/env python3
# Результат: ПРИБОР, не инструмент. Константы вмешательства выведены из истории, а не назначены. Решение, которое оно меняет: значения порогов gentle/proactive; срок — очередной пересмотр калибровки
# Проверка результата: python3 scripts/calibrate.py --history … --output … — отчёт собран, пороги сверены с кодом
#
"""
