...
Повод (2026-08-21). В реестре `scripts/measurements.tsv` четырнадцать замеров, и все
меряют систему про саму себя: не разошёлся ли seed, живы ли задания launchd, не пухнет
