...
**Файлы.** `hooks/external-correction-gap.sh` (UserPromptSubmit, advisory), тест `hooks/tests/test_external_correction_gap.sh` (10 проверок), регистрация в `install.sh` (HOOKS_CONFIG → UserPromptSubmit).
